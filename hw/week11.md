...
For your project:
- Draft a "Bill of Materials" for your project: this is a list of the components you'll need to build your project. Each entry in the list should include a description, and a "source": where you'll get the part -- a link if you plan to buy it, or "Hybrid Lab" if the lab has one you plan to use, but please confirm in the lab that the part is available! **[Send it to me](mailto:jzamfirescupereira@cca.edu) by Monday night, 11pm**.
- **Acquire all the parts on your Bill of Materials and bring them with you to the next class! (As well as your laptop, Arduino, etc.)**